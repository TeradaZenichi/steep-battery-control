"""MHA experiment pack. Run: python scripts/run_MHA.py

MHA is the slower arch; comment out ablations in EXPERIMENTS if compute is tight.
...
if __name__ == "__main__":
    run_experiments("MHA", EXPERIMENTS)
