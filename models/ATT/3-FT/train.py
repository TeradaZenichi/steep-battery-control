...
ALGO_ROOT    = Path(__file__).resolve().parent      # .../models/ATT/3-FT
...
class Train:
    def __init__(self, tariff: str):
        ...
        self.folder = PROJECT_ROOT / "Results" / "train" / "ATT" / "3-FT" / self.tariff
        ...
        self.il_ckpt = PROJECT_ROOT / str(
            self.ft_cfg.get("il_checkpoint_pattern", "Results/train/ATT/1-IL/{tariff}/best.pth").format(
                tariff=self.tariff
            )
        )
