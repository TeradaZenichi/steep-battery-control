...
def main() -> None:
    ...
    for tariff in TARIFFS:
        out_dir = RESULTS_ROOT / "figures" / "TCN" / MODEL_NAME / tariff
        ...
        for entry in entries:
            ...
            actor_csv = RESULTS_ROOT / SPLIT / "TCN" / MODEL_NAME / tariff / f"{name}{ACTOR_SUFFIX}"
            teacher_csv = RESULTS_ROOT / SPLIT / "TCN" / MODEL_NAME / tariff / f"{name}{TEACHER_SUFFIX}"
