...
# Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Attention + Memory Actor Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
class AttentionMemActor(nn.Module):
    ...
    Architecture:
        Input (B, T, 23)
        Ã¢â€ â€™ Linear projection to d_model + positional encoding
        Ã¢â€ â€™ TransformerEncoder (causal, pre-norm)
        Ã¢â€ â€™ GRU memory cell over attended sequence
        Ã¢â€ â€™ LayerNorm on final hidden state
    ...
    def __init__(
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Transformer backbone Ã¢â€â‚¬Ã¢â€â‚¬
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Post-attention GRU memory Ã¢â€â‚¬Ã¢â€â‚¬
        self.memory = nn.GRU(
            input_size=d_model,
        ...
        # Ã¢â€â‚¬Ã¢â€â‚¬ Output heads Ã¢â€â‚¬Ã¢â€â‚¬
...
class AttentionMemQNet(nn.Module):
    def __init__(
        self,
        state_dim: int,
        action_dim: int,
...
def load_critic(critic_cfg: dict, device=None):
    ...
    critics = Critic(
        ...
        head_dim=head_dim,
        d_model=critic_cfg.get("d_model", 128),
        nhead=critic_cfg.get("nhead", 4),
        num_layers=critic_cfg.get("num_layers", 2),
        d_ff=critic_cfg.get("d_ff", 512),
        mem_hidden=critic_cfg.get("mem_hidden", 128),
        mem_layers=critic_cfg.get("mem_layers", 1),
        max_seq_len=critic_cfg.get("max_seq_len", 288),
    )
    if device is not None:
