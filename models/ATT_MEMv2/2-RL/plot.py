...
# CONFIG (EDIT HERE)
# =============================================================================
MODEL_NAME = Path(__file__).resolve().parent.name     # "2-RL"
SPLIT = "test"
...
def main() -> None:
    ...
    for tariff in TARIFFS:
        out_dir = RESULTS_ROOT / "figures" / "ATT_MEMv2" / MODEL_NAME / tariff
        ...
        for entry in entries:
            ...
            actor_csv = RESULTS_ROOT / SPLIT / "ATT_MEMv2" / MODEL_NAME / tariff / f"{name}{ACTOR_SUFFIX}"
            teacher_csv = RESULTS_ROOT / SPLIT / "ATT_MEMv2" / MODEL_NAME / tariff / f"{name}{TEACHER_SUFFIX}"
