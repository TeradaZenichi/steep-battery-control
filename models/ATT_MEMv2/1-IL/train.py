...
ALGO_ROOT    = Path(__file__).resolve().parent      # .../models/ATT_MEMv2/1-IL
sys.path.insert(0, str(PROJECT_ROOT))
sys.path.insert(0, str(ATT_MEMv2_ROOT))
...
def main():
    ...
    for tariff in ["tar_s", "tar_w", "tar_sw", "tar_tou", "tar_flat"]:
        folder = PROJECT_ROOT / "Results" / "train" / "ATT_MEMv2" / "1-IL" / tariff
