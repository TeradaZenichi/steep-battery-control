...
class Train:
    def __init__(self, tariff: str):
        ...
        # Defina o tamanho do episÃƒÆ’Ã‚Â³dio (nÃƒÆ’Ã‚Âºmero de steps por episÃƒÆ’Ã‚Â³dio)
        ...
        self.folder = PROJECT_ROOT / "Results" / "train" / "GRUv2" / "2-RL" / self.tariff
        self.folder.mkdir(parents=True, exist_ok=True)

        # Arquivos ÃƒÆ’Ã‚Âºnicos (sobrescrevem)
        ...
        self.critic_cfg.setdefault("hidden_dim", int(self.model_cfg["actor"].get("hidden_dim", 256)))
        self.critic_cfg.setdefault("num_layers", int(self.model_cfg["actor"].get("num_layers", 1)))
