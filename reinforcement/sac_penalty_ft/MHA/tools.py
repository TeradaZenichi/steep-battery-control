"""Small presentation helpers for GRU 2-RL training."""
import math
            ...
            self.pbar.set_postfix(
                {
                    ...
                    "lambda": _fmt(self._last_row.get("lambda_value")),
                }
            )
    ...
    pbar.set_postfix(
        {
            ...
            "lambda": _fmt(agg.get("lambda_value")),
            "viol": _fmt(agg.get("violation_mean")),
