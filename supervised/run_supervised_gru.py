"""Supervised BC training — GRU machine. Hardcoded config (no argparse).

Trains the 5 tariffs of GRU via supervised/GRU/train.py. Forces CPU
...
Output: paper/train/supervised/GRU/<tariff>/best.pt

Run from project root:
    python supervised/run_supervised_gru.py
"""
import os
import subprocess
import sys
