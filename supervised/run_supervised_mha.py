"""Supervised BC training — MHA machine. Hardcoded config (no argparse).

Trains the 5 tariffs of MHA via supervised/MHA/train.py. Forces CPU
...
Output: paper/train/supervised/MHA/<tariff>/best.pt

Run from project root:
    python supervised/run_supervised_mha.py
"""
import os
import subprocess
import sys
