...
def _ensure_configs():
    ...
    from sac.ablation.run_hp_ablation import generate as gen_ablation   # makes hp_ent2, hp_shaped, ...
    from sac.ablation.run_ft_comparison import generate as gen_ft       # makes cmp_ft
    gen_ablation()
    gen_ft()
